...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_serverShowMoreStyles__WEBPACK_IMPORTED_MODULE_6__["default"])('.button-styles', '.styles-2');
});
...
var serverShowMoreStyles = function serverShowMoreStyles(trigger, styles) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getResource"])('http://localhost:3000/styles').then(function (res) {
