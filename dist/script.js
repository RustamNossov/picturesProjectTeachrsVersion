...
/* harmony import */ var _modules_serverShowMoreStyles__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/serverShowMoreStyles */ "./src/js/modules/serverShowMoreStyles.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_serverShowMoreStyles__WEBPACK_IMPORTED_MODULE_6__["default"])('.button-styles', '#styles .row');
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      input.previousElementSibling.textContent = 'Файл ' + name + ' загружен';
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var statusImg = document.createElement('img'); //statusImg.classList.add('img-dfd');
      ...
      var api;
      item.closest('.popup-design') || item.classList.contains('calc-form') ? api = path.designer : api = path.question; //console.log(api);
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrolHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight);
...
var scrolling = function scrolling(upSelector) {
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      var hightTop = document.documentElement.scrollTop,
          hash = this.hash,
      ...
      function step(time) {
        ...
        var progress = time - start,
            r = toBlock < 0 ? Math.max(hightTop - progress / speed, hightTop + toBlock) : Math.min(hightTop + progress / speed, hightTop + toBlock);
...
/***/ "./src/js/modules/serverShowMoreStyles.js":
/*!************************************************!*\
  !*** ./src/js/modules/serverShowMoreStyles.js ***!
  \************************************************/
/*! exports provided: default */
...
var serverShowMoreStyles = function serverShowMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    ...
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:3000/styles').then(function (res) {
      var picturesObj = JSON.parse(res);
...
/* harmony default export */ __webpack_exports__["default"] = (serverShowMoreStyles);
...
var sliders = function sliders(slidesSelector, direction, prevSelector, nextSelector) {
  var slideIndex = 1,
      paused = false;
  var items = document.querySelectorAll(slidesSelector);
